import { projectImage, type ResponsiveImageAsset } from './imageAssets'
...
const pinnedProject: Project = {
  ...
  images: [
    projectImage('uptown-dance-homepage'),
    projectImage('uptown-admin-dashboard'),
    projectImage('uptown-member-dashboard'),
  ],
}
...
export const projects: Project[] = [
  pinnedProject,
  {
    ...
    image: projectImage('eurobahn-collision-center'),
  },
  {
    ...
    images: [
      projectImage('gpf-homepage'),
      projectImage('gpf-vision-for-the-future'),
      projectImage('gpf-about-us'),
    ],
  },
  {
    ...
    images: [
      projectImage('contour-cabinets-homepage'),
      projectImage('contour-cabinets-shop'),
    ],
  },
  {
    ...
    image: projectImage('zion-construction-homepage'),
  },
  {
    ...
    image: projectImage('js-garden-works-homepage'),
  },
  {
    ...
    image: projectImage('5-collision-guys-tampa-homepage'),
  },
  {
